...
<body>
  ...
  { ?>
                  <li>
                    <a data-toggle="tab" href="#overview">liste des lettres de liaison</a>
                  </li>
                  <li class="active">
                    <a data-toggle="tab" href="#edit">Modifier une lettre de liaison </a>
                  </li>
...
<li class="active">
                  ...
                  <li >
                    <a data-toggle="tab" href="#edit">Ajouter une lettre de liaison</a>
                  </li>
                  ...
                  <div id="edit" class="tab-pane">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        <h4 class="mb">lettre de liason</h4>
