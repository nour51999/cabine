...
<li class="active">
                    <a data-toggle="tab" href="#overview">liste des Diagnostiques</a>
                  </li>
                  <li >
                    <a data-toggle="tab" href="#edit"> Diagnostique</a>
                  </li>
                  ...
                  <div id="edit" class="tab-pane">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        <h4 class="mb">Diagnostique</h4>
                        <form role="form" class="form-horizontal"method="post" action="trtm/insctcons.php" >
...
<?php include('trtm/listpas.php');?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" placeholder=" " id="cmnt1" name="cmnt1" class="form-control">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Symptoms</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder=" " id="cmnt2" name="cmnt2" class="form-control">
                            </div>
                          </div>
